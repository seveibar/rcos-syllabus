...
\begin{document}
    ...
    Slack can be accessed from the web or mobile devices, and it's expected that every student check their project's Slack atleast once a week. Slack can be accessed from \textbf{rcos.slack.com}
